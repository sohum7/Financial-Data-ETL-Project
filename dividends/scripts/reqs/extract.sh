...
pip freeze | grep google-cloud-storage >> $req_path/requirements.txt
pip freeze | grep google-cloud-logging >> $req_path/requirements.txt
pip freeze | grep google-cloud-secret-manager >> $req_path/requirements.txt
